...
info = pl.read_csv("./data/Metadata_Indicator_API_Download_DS2_en_csv_v2_5657328.csv", truncate_ragged_lines=True).rename({"INDICATOR_CODE":"Indicator Code", "INDICATOR_NAME":"Indicator Name"})
...
#%%
# have to format the data a bit different for this chart
drop_country = ["ZAF"]
